	 ...
	 <div class="span3" id="sidebar">
                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						 ...
						 <li>						
                            ...
                            <li class="">
                            <a href="donations.php"><i class="icon-chevron-right"></i><i class="icon-user"></i> my donations</a>
                            </li>
						   				
						    <li>
                            <a href="pledge.php"><i class="icon-chevron-right"></i><i class="icon-laptop"></i> pledges
							</a>
                            </li>
                          ...
                          <!------/.* finance sidebar*------->
					    <li>						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs1"><i class="icon-chevron-right"></i><i class="icon-globe"></i>&nbsp;Donations/fundraising
							<div class="muted pull-right"><i class="caret"></i></div></a>						
						    <ul id="bs1" class="collapse">						
                            <li class="">
                            <a href="donations.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> Donate Now</a>
                            </li>
						    <li class="">
                            <a href="fundraising.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> Fundraise</a>
                            </li>
							<li class="">
                            <a href="pledge.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> Pledge now</a>
                            </li>
						    </ul>
						</li>
					  ...
					  <!------/.* manage System user sidebar*------->	
						...
						<li>						
						    ...
						    <li class="">
                            <a href="upcoming.php"><i class="icon-chevron-right"></i><i class="icon-calendar"></i> Upcoming Charity visits </a>
                            </li>
						    </ul>
						</li>
