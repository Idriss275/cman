   <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-plus-sign icon-large"> Enter Your Pledge</i></div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form method="post">
										...
										<div class="control-group">
                                          <div class="controls">
                                            <input class="input focused" name="trcode" id="focusedInput" type="text" placeholder = "Phone Number" required>
                                          </div>
                                        </div>
