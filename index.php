...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body>
        <div class="container">
            ...
            <header>
                <h1>COMPASSION <span>CONNECT</span></h1>
                        ...
                        <div id="register" class="animate form">
                            <form  action="reg.php" method="POST" autocomplete="on"> 
                                ...
                                <p> 
                                    ...
                                    <input id="usernamesignup" name="fname" required="required" type="text" placeholder="Juma" />
                                </p>
                                <p> 
                                    <label for="usernamesignup" class="uname" data-icon="u" > Middle Name</label>
                                    <input id="usernamesignup" name="sname" required="required" type="text" placeholder="Abdalla"/> 
                                </p>
								<p> 
                                    <label for="usernamesignup" class="uname" data-icon="u">Last Name</label>
                                    <input id="usernamesignup" name="lname" required="required" type="text" placeholder="Juma" />
                                </p>
								<p> 
  ...
  <option value="Female">Female</option>
								...
								<p> 
                                    ...
                                    <input id="usernamesignup" type="date" name="birthday" min="2001-05-27" />
                                </p>
								<p> 
                                    <label for="usernamesignup" class="uname" data-icon="u">Residence</label>
                                    <input id="usernamesignup" name="residence" required="required" type="text" placeholder="Arusha" />
                                </p>
								<p> 
                                    <label for="usernamesignup" class="uname" data-icon="u">Place of Birth</label>
                                    <input id="usernamesignup" name="pob" required="required" type="text" placeholder="Arusha" />
                                </p>
								<p> 
  ...
  <option value="Praise and Worship">Children and school</option>
  <option value="Ushering">Elders</option>
  <option value="Hostessing">Homeless</option>
  <option value="Media and IT">Donor</option>
  <option value="Sunday School">Volunteer</option>
</select> 
                                </p>
								 <p> 
