                 ...
                 ?>	 
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"></i><i class="icon-members"></i> Charity members (s) List</div>
								<div class="muted pull-right">
								Number of charity members: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                            </div>
