	 ...
	 <div class="span3" id="sidebar">
                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                         ...
                         <!--- Visitors management------->
                          ...
                          <!------/.* finance sidebar*------->
					    <li>						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs1"><i class="icon-chevron-right"></i><i class="icon-money"></i>&nbsp;Donations/Fundsraised
							<div class="muted pull-right"><i class="caret"></i></div></a>						
						    <ul id="bs1" class="collapse">						
                            <li class="">
                            <a href="fundraising.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> Fundsraised</a>
                            </li>
							<li class="">
                            <a href="addfunds.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign-alt"></i> Add Funds</a>
                            </li>
						    <li class="">
                            <a href="pledge.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> pledges</a>
                            </li>
							<li class="">
                            <a href="addpledge.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign-alt"></i>Add pledges</a>
                            </li>
							<li class="">
                            <a href="Donation.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> Other Donations</a>
                            </li>
							<li class="">
                            <a href="adddonations.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign-alt"></i> Add Other donations</a>
                            </li>
						    </ul>
						</li>
