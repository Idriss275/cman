   <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-plus-sign icon-large"> Enter  fundraised</i></div>
                            </div>
...
?>
<script>
window.location = "pledge.php";
$.jGrowl("The pledge is Successfully added", { header: 'pledge added' });
</script>
<?php
}
